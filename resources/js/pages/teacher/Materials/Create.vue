...
import { index as materialsIndex, store } from '@/actions/App/Http/Controllers/Teacher/MaterialController';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Materi', href: '/teacher/materials/create' },
];
        ...
        <div class="flex flex-col gap-6 p-4 md:p-6">
            ...
            <Card class="max-w-2xl">
                <CardHeader>
                    ...
                    <CardDescription>
                        Buat materi pembelajaran untuk siswa Anda
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Maksimal 50MB. PDF, DOC, PPT, video, audio, atau gambar.
                            </p>
